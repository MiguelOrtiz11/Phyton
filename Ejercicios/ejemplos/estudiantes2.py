...
def notapromedio():
    ...
    print("la nota promedio de los", len(estudiantes), "estudiantes es '{}'".format(promedio))
...
def borrarestudiante():
    ...
    if indice == -1:
        print("No se ha encontrado el estudiante'{}'".format(nombre))
        return False
    print("se ha eliminado al estudiante '{}' con nota {}".format(nombre,estudiantes[indice][1]))
