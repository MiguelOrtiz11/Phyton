...
def promedioMes():
    pedirMes = str(input("ingrese un mes desde julio hasta diciembre: "))

    if (pedirMes == julio):
        print("El promedio de inflaciones en julio fue de: " + julio)
    elif (pedirMes == agosto):
        print("El promedio de inflaciones en agosto fue de: " + agosto)
    elif (pedirMes == septiembre):
        print("El promedio de inflaciones en septiembre fue de: " + septiembre)
    elif (pedirMes == octubre):
        print("El promedio de inflaciones en octubre fue de: " + octubre)
    elif (pedirMes == noviembre):
        print("El promedio de inflaciones en noviembre fue de: " + noviembre)
    elif (pedirMes == diciembre):
        print("El promedio de inflaciones en diciembre fue de: " + diciembre)
